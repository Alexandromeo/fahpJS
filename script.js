...
const dbPromise = idb.open("rt", 1, function(upgradeDb) {
  if (!upgradeDb.objectStoreNames.contains("pemilihan")) {
    const peopleOS = upgradeDb.createObjectStore("pemilihan", { keyPath: "id", autoIncrement: true });
  }
});
...
const calculateProcess = () => {
  return new Promise((resolve, reject) => {
     const usia = document.querySelector("#usia").value/100
          ...
          const karisma = document.querySelector("#karisma").value

          const usia2 = document.querySelector("#usia2").value/100
          const pengalaman2 = document.querySelector("#pengalaman2").value
          const karisma2 = document.querySelector("#karisma2").value

          const usia3 = document.querySelector("#usia3").value/100
          const pengalaman3 = document.querySelector("#pengalaman3").value
          const karisma3 = document.querySelector("#karisma3").value
          ...
          const calExp = 
          [
            pengalaman/pengalaman, pengalaman/pengalaman2, pengalaman/pengalaman3, //o1
            pengalaman2/pengalaman, pengalaman2/pengalaman2, pengalaman2/pengalaman3, //o2
            pengalaman3/pengalaman, pengalaman3/pengalaman2, pengalaman3/pengalaman3  //o3
          ]
          ...
          const calKhar = 
          [
            karisma/karisma, karisma/karisma2, karisma/karisma3, //o1
            karisma2/karisma, karisma2/karisma2, karisma2/karisma3, //o2
            karisma3/karisma, karisma3/karisma2, karisma3/karisma3  //o3
          ]
